...
- `--dry-run` shows planned actions without synthesizing
...
### Issue 12 - YapperKit public API stabilization
...
- Completed chapters are not re-synthesized

### Issue 14 - Epub reader integration support

- Paragraph-level streaming API (synthesize one paragraph, callback, next)
...
|---|---|---|---|
| Phase 1 (Foundation) | #1-#3 | ✅ Done (v0.3.0) | YapperKit synthesizes text to audio, numerically identical to KokoroSwift |
